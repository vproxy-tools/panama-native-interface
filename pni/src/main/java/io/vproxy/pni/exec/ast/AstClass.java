...
public class AstClass {
    ...
    private void generateJava(StringBuilder sb) {
        ...
        if (!isInterface) {
            ...
            sb.append("        }\n");
            sb.append("\n");
            sb.append("        private Func(io.vproxy.pni.CallSite<").append(simpleName()).append("> func, Options opts) {\n");
            ...
            sb.append("        }\n");
            sb.append("\n");
            sb.append("        public static Func of(io.vproxy.pni.CallSite<").append(simpleName()).append("> func, Options opts) {\n");
