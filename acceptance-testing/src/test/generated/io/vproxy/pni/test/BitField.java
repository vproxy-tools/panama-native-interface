...
public class BitField extends AbstractNativeObject implements NativeObject {
    ...
    private static final MethodHandle nMH = PanamaUtils.lookupPNICriticalFunction(new PNILinkOptions(), long.class, "JavaCritical_io_vproxy_pni_test_BitField_n", MemorySegment.class /* self */);
    ...
    private static final MethodHandle n2MH = PanamaUtils.lookupPNICriticalFunction(new PNILinkOptions(), long.class, "JavaCritical_io_vproxy_pni_test_BitField_n2", MemorySegment.class /* self */);
...
// sha256:debcd83d479a6ab68b1bbcf37a3faf5b8193545caa9328f64db7e60471b18a43
